...
module InsertTest = 
  ...
  let ``insert : assigned id``() =
    ...
    let department = MsSqlCe.insert con department
  ...
  let ``insert : assigned composite id``() =
    ...
    let employee = MsSqlCe.insert con employee
    printfn "%A" employee
  ...
  let ``insert : no id``() =
    ...
    let noId = MsSqlCe.insert con noId
    printfn "%A" noId
  ...
  let ``insert : no version``() =
    ...
    let noVersion = MsSqlCe.insert con noVersion
    printfn "%A" noVersion
  ...
  let ``insert : unique constraint violation``() =
    ...
    try
      MsSqlCe.insert con department |> ignore
      fail ()
    with 
  ...
  let ``insert : computed version``() =
    ...
    let address = MsSqlCe.insert con address
    printfn "%A" address
