...
module InsertTest = 
  ...
  let ``insert : assigned id``() =
    ...
    let department = MySql.insert department
  ...
  let ``insert : assigned composite id``() =
    ...
    let employee = MySql.insert employee
    printfn "%A" employee
  ...
  let ``insert : no version``() =
    ...
    let noVersion = MySql.insert noVersion
    printfn "%A" noVersion
  ...
  let ``insert : unique constraint violation``() =
    ...
    try
      MySql.insert department |> ignore
      fail ()
    with 
...
(*
  ...
  let ``insert : computed version``() =
    ...
    let address = MySql.insert address
    printfn "%A" address
